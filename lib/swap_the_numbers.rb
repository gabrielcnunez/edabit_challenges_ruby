# Swap the Numbers
# Imagine you have three numbers: a, b, and c. c is equal to either a or b, 
...
# and if c is equal to b, return a. Here's what makes this challenge 
# difficult: you cannot use any if statements.
