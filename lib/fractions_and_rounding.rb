...
# Given a fraction (given in the format "1/2" for example) and n number 
# of decimal places, return a sentence in the following format:
...
# Notes
# Add trailing zeros if n is greater than the actual number of decimal 
# places the fraction has (see example #2).
# Numbers greater than one may be given as top-heavy fractions (no mixed 
# numbers).
# n won't be 1 because that would cause "decimal places" to be "decimal 
